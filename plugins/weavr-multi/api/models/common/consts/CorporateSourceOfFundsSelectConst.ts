...
export const CorporateSourceOfFundsSelectConst: {
    value: CorporateSourceOfFundTypeEnum
    text: string
}[] = [
    ...
    {
        value: CorporateSourceOfFundTypeEnum.ORDINARY_BUSINESS_ACTIVITY,
    ...
    {
        value: CorporateSourceOfFundTypeEnum.LOAN_FROM_THIRD_PARTIES,
        text: 'Loan from third parties',
    },
    {
        value: CorporateSourceOfFundTypeEnum.SALE_OF_COMPANY_SHARES_BUSINESS,

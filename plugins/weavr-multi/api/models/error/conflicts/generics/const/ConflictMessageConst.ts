...
export const CONFLICT_MESSAGE_CONST: Record<any, string> = {
    [CreateIdentityConflictsEnum.ROOT_EMAIL_NOT_UNIQUE]:
    ...
    [VerifyTokenConflictsEnum.VERIFICATION_CODE_EXPIRED]:
        'The verification code entered has expired.',
    [VerifyTokenConflictsEnum.VERIFICATION_CODE_INVALID]:

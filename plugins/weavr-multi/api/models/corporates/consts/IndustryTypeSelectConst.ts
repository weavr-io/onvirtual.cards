...
export const IndustryTypeSelectConst: { value: string; text: string }[] = [
    ...
    { value: IndustryTypeEnum.EDUCATION_PROFESSIONAL_SERVICES, text: "Education/Professional services" },
    ...
    { value: IndustryTypeEnum.MANUFACTURINGPR_MARKETING, text: "ManufacturingPR/Marketing" },
    { value: IndustryTypeEnum.PRECIOUS_GOODS_JEWELRY, text: "Precious goods/ Jewelry" },
    { value: IndustryTypeEnum.NON_GOVERNMENTAL_ORGANIZATION, text: "Non-governmental organization" },

...
// const PREDEFINED_CORPORATE_SOURCE_OF_FUND = Object.keys(CorporateSourceOfFundTypeEnum).filter(
//     (value) => {
//         return value === CorporateSourceOfFundTypeEnum.OTHER
//     },
// )

enum PREDEFINED_CORPORATE_SOURCE_OF_FUND {
    LABOUR_CONTRACT = 'LABOUR_CONTRACT',
    CIVIL_CONTRACT = 'CIVIL_CONTRACT',
    RENT = 'RENT',
    FUNDS_FROM_OTHER_AUXILIARY_SOURCES = 'FUNDS_FROM_OTHER_AUXILIARY_SOURCES',

...
export class UsersApi {
  ...
  update(params: { id: IDModel; data: UpdateUserRequestModel }): Promise<AxiosResponse<UserModel>> {
  ...
  inviteValidate(params: { id: IDModel; data: InviteValidateRequestModel }): Promise<AxiosResponse> {
    return $axiosMulti.post('/users/' + params.id + '/invite/validate', params.data)
  }

  inviteConsume(params: { id: IDModel; data: InviteConsumeRequestModel }): Promise<AxiosResponse> {

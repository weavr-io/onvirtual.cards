      ...
      uiConf: {
        ...
        steps: {
          ...
          COMPANY: {
            ...
            subTitle: 'Step 1: Business Details',
            instructions:
          ...
          REVIEW: {
            instructions:
              'Please check and review all the provided information and make sure that all the data is valid and belongs to you.'
          },
          STATUS: {
            pending: {
              title: 'We are reviewing your documents. This process usually takes up to 3 business days.',
              instructions:
                'Your documents are under review. The status of your account will change automatically once the review is completed. If you experience any difficulties, please contact customer support.'
            }
          },
          APPLICANT_REQUEST: {

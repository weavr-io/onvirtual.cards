      ...
      <b-card-body class="p-card">
        <div class="form-screens">
          ...
          <div class="form-screen">
            ...
            I accept the <a href="https://www.onvirtual.cards/terms/consumer" target="_blank" class="text-decoration-underline text-muted">terms of use</a> and <a href="https://www.onvirtual.cards/policy/" target="_blank" class="text-decoration-underline text-muted">privacy policy</a>
                    </b-form-checkbox>
                    <b-form-invalid-feedback>This field is required.</b-form-invalid-feedback>
                  </b-form-group>
                </b-col>

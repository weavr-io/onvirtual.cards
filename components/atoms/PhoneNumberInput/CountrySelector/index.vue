            ...
            >
                ...
                >
                    <button
                        ...
                        :style="[itemHeight, value === item.iso2 ? bgItemSelectedStyle : null]"
                        tabindex="-1"
                        type="button"
...
export default {
    ...
    computed: {
        ...
        selectedValueIndex() {
            return this.value ? this.countriesSorted.findIndex((c) => c.iso2 === this.value) : null
        },
        tmpValueIndex() {
        ...
        scrollToSelectedOnFocus(arrayIndex) {
            this.$nextTick(() => {
                ...
                this.$refs.countriesList.scrollTop =
                    arrayIndex * (this.countriesHeight + 1) - (this.countriesHeight + 1) * 3
            })
        },
        keyboardNav(e) {
